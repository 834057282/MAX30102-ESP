...
#define REG_INTR_ENABLE_1 (const uint8_t *)0x02
#define REG_INTR_ENABLE_2 (const uint8_t *)0x03
#define REG_FIFO_WR_PTR (const uint8_t *)0x04
#define REG_OVF_COUNTER (const uint8_t *)0x05
#define REG_FIFO_RD_PTR (const uint8_t *)0x06
#define REG_FIFO_DATA 0x07
#define REG_FIFO_CONFIG (const uint8_t *)0x08
#define REG_MODE_CONFIG (const uint8_t *)0x09
#define REG_SPO2_CONFIG (const uint8_t *)0x0A
#define REG_LED1_PA (const uint8_t *)0x0C
#define REG_LED2_PA (const uint8_t *)0x0D
#define REG_PILOT_PA (const uint8_t *)0x10
#define REG_MULTI_LED_CTRL1 0x11
#define REG_MULTI_LED_CTRL2 0x12
#define REG_TEMP_INTR 0x1F
#define REG_TEMP_FRAC 0x20
#define REG_TEMP_CONFIG (const uint8_t *)0x21
